...
export const newRunner = (config, { unitCollector, stopTimer }, dependencies = productionDeps) => {
  const { reporter } = config;
  return runner(unitCollector, stopTimer, { ...dependencies, reporter });
};
export const runner = (unitCollector, stopTimer, dependencies = productionDeps) => {
